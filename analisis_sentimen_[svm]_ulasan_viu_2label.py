# -*- coding: utf-8 -*-
"""Analisis Sentimen - [SVM] - Ulasan Viu - 2Label.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1xg4S2rS76qEZ5_fi20DWhDgnl8L5GjZH
...
df = pd.read_csv("/content/drive/MyDrive/Dataset Ulasan Google Play/scrapped_data_Viu_1_5K.csv")
df.head()
...
# df['steamming'].to_csv('/content/drive/MyDrive/Dataset Ulasan Google Play/hasil_steamming_Viu_1.csv', index = False)

df_steamming = pd.read_csv('/content/drive/MyDrive/Dataset Ulasan Google Play/hasil_steamming_Viu_1_5K.csv', encoding = 'latin1')
df_steamming
...
# df_values.to_csv('/content/drive/MyDrive/Dataset Ulasan Google Play/hasil_terjemahan_Viu_1_5K.csv')

# Load Dataset Hasil Translate

df_values = pd.read_csv('/content/drive/MyDrive/Dataset Ulasan Google Play/hasil_terjemahan_Viu_1_5K.csv', index_col=0)
df_values
...
df_values = pd.read_csv('/content/drive/MyDrive/Dataset Ulasan Google Play/hasil_terjemahan_OYO_1.csv', index_col=0)
df_values
...
show_bar_chart(labels, counts, "Distribusi Sentimen Ulasan Aplikasi Viu")
...
show_pie_chart(labels, counts, "Distribusi Sentimen Ulasan Aplikasi Viu")
